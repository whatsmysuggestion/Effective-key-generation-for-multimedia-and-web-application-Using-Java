...
public class Inbox extends JFrame
{
	...
	public Inbox(String user,String pass)
	{
		super();
		try
		{
	...
	private void initializeComponent()
	{
		...
		jLabel2.setText("The Messages in Your Inbox are...");
	...
	public void sendToOutbox(String receiver,String ia,String sctkey,String subject, String dtxt)
	{
		...
		int flag = 1;
		st.executeUpdate("Insert into "+gettable+" values ('"+receiver+"','"+ia+"','"+sctkey+"','"+subject+"','"+dtxt+"',"+flag+")");
