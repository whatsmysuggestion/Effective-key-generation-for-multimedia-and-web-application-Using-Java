...
public class GrpCtrler extends JFrame
{
	...
	private void initializeComponent()
	{
		...
		// add
		//
		add.setIcon(new ImageIcon("joinmem.jpg"));
		...
		// leave
		//
		leave.setIcon(new ImageIcon("leavemem.jpg"));
		...
		// keygenerate
		//
		keygenerate.setIcon(new ImageIcon("keys.jpg"));
		...
		// tree
		//
		tree.setIcon(new ImageIcon("tree.jpg"));
