...
/**
 * Summary description for ShowOutbox
 *
 */
public class ShowOutbox extends JFrame
{
	// Variables declaration
	Connection con;
	Statement st;
	ResultSet rs;
	String id,key,str,sender,receiver,data,sub,flag;
	Socket skt;
	ServerSocket ss;
	DataInputStream dis;
	String val1,val2,val3;
	String gettable,stext;
	FileInputStream fis;
	...
	public ShowOutbox(String user,String pass)
	{
		super();
		try
		{
	...
	private void initializeComponent()
	{
		...
		// ShowOutbox
		//
		this.setTitle("Show Outbox Window");
	...
	private void send_mouseClicked(MouseEvent e)
	{
		...
		int row=jTable1.getSelectedRow();
	       	...
	       	try
			{
				...
				String subject=JOptionPane.showInputDialog(this,"Give the Subject");
				sendTo(subject+".txt",str,key, subject,data);
	...
	private void sendtoall_mouseClicked(MouseEvent e)
	{
		...
		int row=jTable1.getSelectedRow();
			...
			if(val1 == null || val2 == null || val3 == null)
	       	...
	       	try
			{
				rs=st.executeQuery("Select * from "+gettable+" where Receiver = '"+val1+"' and 	Message = '"+val3+"' and Sender = '"+val2+"'");
				while(rs.next())
				{
					key=rs.getString("Sctkey");
					data=rs.getString("Message");
				...
				sendToAll(sub+".txt",str,key,sub, data);
	...
	public void sendTo(String fname,String receiver,String sctkey, String subject, String sfile)
	{
		try
		{
	...
	public void sendToAll(String fname,String receiver,String sctkey,String subject, String sname)
	{
		int count=0;
		try
		{
